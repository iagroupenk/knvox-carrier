...
function layout(t,b,s){return`<!doctype html><html lang="fr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${esc(t)} · KNVOX</title><link rel="stylesheet" href="/admin.css"></head><body><header><b>KNVOX Admin</b><nav><a href="/admin">Dashboard</a><a href="/admin/clients">Clients</a><a href="/admin/monitoring">Monitoring</a><a href="/admin/evidence">Evidence</a><a href="/admin/logout">Déconnexion</a>${s?`<span>${esc(s.u)}</span>`:""}</nav></header><main>${b}</main></body></html>`}
